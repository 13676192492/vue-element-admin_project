    ...
    <div class="form-box txt-class">
      <el-form ref="dataForm" :model="rechargeFormData" :rules="rechargeRules">
        ...
        <el-form-item prop="total_amount">
          ...
          <el-input
            class="input-class"
            v-if="rechargeState === 3"
            v-model="rechargeFormData.total_amount"
            placeholder="请输入充值金额"
            clearable
          />
          <span
            ...
            >元</span
          >
          <span class="txt-class" v-else
            >{{ rechargeFormData.total_amount }} 元</span
          >
        </el-form-item>
        <el-form-item prop="method">
          ...
          <el-button
            class="btns"
            :class="rechargeFormData.method === 2 ? 'btns-click' : ''"
            @click="selectWay(2)"
            ><i></i>支付宝</el-button
          >
      ...
      <div class="btn-box">
        ...
        <span v-if="rechargeState !== 3"
          >已生成充值订单，目前订单处于未支付状态，请再次点击充值完成支付</span
        >
        ...
        if (valid) {
          ...
          payRecharge(this.rechargeFormData).then(res => {
            if (res.data.success) {
              ...
              window.open(
                `${location.protocol}//${location.host}?data=${res.data.data.data}`
              );
