  ...
  <div>
    <div class="app-container" v-show="!param.isShow">
      ...
      >
        ...
        <el-table-column label="支付状态" prop="orderStatus"> </el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            <div class="btnGroup">
              <el-tag>
                <el-button type="text" @click="orderDetails(scope.row)"
                  >详情</el-button
                >
              </el-tag>
            </div>
...
<script>
import { getAdminOrderList } from "@/api/order/spendingOrder";
